...
[![MIT License](https://img.shields.io/badge/license-MIT-green.svg)](https://github.com/Hyperrick/spotpdf/blob/v0.6.0/LICENSE)
...
[`examples/create_demo_pdf.py`](https://github.com/Hyperrick/spotpdf/blob/v0.6.0/examples/create_demo_pdf.py). No customer or
...
<table>
  ...
  <tbody>
    <tr>
      <td><a href="https://github.com/Hyperrick/spotpdf/blob/v0.6.0/docs/images/demo-before.png"><img src="https://raw.githubusercontent.com/Hyperrick/spotpdf/v0.6.0/docs/images/demo-before.png" alt="Synthetic vector PDF before processing, with a blue process-color block, pink varnish fill, pink cut contour, and green personalization text"></a></td>
      <td><a href="https://github.com/Hyperrick/spotpdf/blob/v0.6.0/docs/images/demo-after.png"><img src="https://raw.githubusercontent.com/Hyperrick/spotpdf/v0.6.0/docs/images/demo-after.png" alt="Synthetic vector PDF after spot removal; the blue process-color block remains while varnish, cut contour, and personalization text are gone"></a></td>
    </tr>
  </tbody>
</table>
...
<a href="https://github.com/Hyperrick/spotpdf/blob/v0.6.0/docs/images/demo-convert.svg"><img src="https://raw.githubusercontent.com/Hyperrick/spotpdf/v0.6.0/docs/images/demo-convert.svg" alt="Terminal walkthrough showing the Varnish spot plate converted to explicit DeviceCMYK while unrelated spots remain and the equivalent composite render stays pixel-identical"></a>
...
<a href="https://github.com/Hyperrick/spotpdf/blob/v0.6.0/docs/images/demo-rename.svg"><img src="https://raw.githubusercontent.com/Hyperrick/spotpdf/v0.6.0/docs/images/demo-rename.svg" alt="Terminal walkthrough showing Varnish renamed to Varnish Renamed while all other spot plates stay unchanged and the render remains pixel-identical"></a>
...
<table>
  ...
  <tbody>
    <tr>
      <td><a href="https://github.com/Hyperrick/spotpdf/blob/v0.6.0/docs/images/demo-before.png"><img src="https://raw.githubusercontent.com/Hyperrick/spotpdf/v0.6.0/docs/images/demo-before.png" alt="Synthetic PDF before the Varnish alternate preview is changed"></a></td>
      <td><a href="https://github.com/Hyperrick/spotpdf/blob/v0.6.0/docs/images/demo-alternate.png"><img src="https://raw.githubusercontent.com/Hyperrick/spotpdf/v0.6.0/docs/images/demo-alternate.png" alt="The same synthetic PDF after only the Varnish alternate preview is changed from magenta to cyan"></a></td>
    </tr>
  </tbody>
</table>
...
[JSON output and automation](https://github.com/Hyperrick/spotpdf/blob/v0.6.0/docs/json-output.md) for the complete result
...
[64/128-spot benchmark](https://github.com/Hyperrick/spotpdf/blob/v0.6.0/docs/performance.md).
...
[PDF compatibility](https://github.com/Hyperrick/spotpdf/blob/v0.6.0/docs/compatibility.md) for the deliberately unsupported
...
See [PDF compatibility](https://github.com/Hyperrick/spotpdf/blob/v0.6.0/docs/compatibility.md) for the exact initial subset.
...
[processing-budget guide](https://github.com/Hyperrick/spotpdf/blob/v0.6.0/docs/processing-budgets.md) and
...
in one viewer. See [architecture](https://github.com/Hyperrick/spotpdf/blob/v0.6.0/docs/architecture.md) for module boundaries and
...
[public prepress corpus](https://github.com/Hyperrick/spotpdf/blob/v0.6.0/docs/public-corpus.md) through qpdf, Poppler, and
Ghostscript `tiffsep`.
...
- [Changelog](https://github.com/Hyperrick/spotpdf/blob/v0.6.0/CHANGELOG.md)
...
- [MIT License](https://github.com/Hyperrick/spotpdf/blob/v0.6.0/LICENSE)
